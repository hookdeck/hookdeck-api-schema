...
exports.Event = core.serialization.object({
    ...
    lastAttemptAt: core.serialization.property("last_attempt_at", core.serialization.string().optional()),
    nextAttemptAt: core.serialization.property("next_attempt_at", core.serialization.string().optional()),
    responseStatus: core.serialization.property("response_status", core.serialization.number().optional()),
    status: core.serialization.lazy(async () => (await Promise.resolve().then(() => __importStar(require("../../..")))).EventStatus),
